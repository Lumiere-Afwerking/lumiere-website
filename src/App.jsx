De 5 Bestanden voor je GitHub Kluis

Hieronder vind je precies welke code in welk bestand moet. Kopieer de codevakken en plak ze in de gelijknamige bestanden in je GitHub.

Bestand 1: package.json

Plak deze code in het bestand genaamd package.json

{
  "name": "lumiere-website",
  "private": true,
  "version": "1.0.0",
  "type": "module",
  "scripts": {
...
Bestand 2: vite.config.js

Plak deze code in het bestand genaamd vite.config.js
...
Bestand 3: index.html

Plak deze code in het bestand genaamd index.html
...
<html lang="nl">
  <head>
    ...
    <title>Lumière | Luxe Wandafwerking Rotterdam</title>
...
Bestand 4: src/main.jsx

Let op: dit bestand moet in een mapje genaamd 'src' staan. Plak deze code in src/main.jsx
...
Bestand 5: src/App.jsx

Dit is de volledige, werkende website met het werkende contactformulier en alle functies. Plak deze enorme lap code in src/App.jsx
